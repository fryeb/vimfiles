...
let g:colors_name="bencolor"

" Set to "256" for 256-color terminals
if !exists("g:bencolor_termcolors")
  let g:bencolor_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:bencolor_terminal_italics")
  let g:bencolor_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:bencolor_terminal_italics == 0
...
function! bencolor#set_highlight(group, style)
...
let s:green = { "gui": "#2eA97b", "cterm": "30" }
